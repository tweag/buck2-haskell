...
def obtain_target_metadata(args):
    ...
    if args.build_plan == None:
        ...
        output = run_ghc_depends(
            ...
            per_module_flags=args.per_module_flags,
        )
...
def run_ghc_depends(
    ...
    per_module_flags: str | None = None,
):
    with tempfile.TemporaryDirectory() as dname:
        ...
        if worker_target_id:
            ...
            worker_args = []
        if per_module_flags is not None:
            worker_args += ["--per-module-flags={}".format(per_module_flags)]
