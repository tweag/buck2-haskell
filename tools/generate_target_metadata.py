...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        action="append",
        help="Arguments passed to the executable directly rather than in an argsfile",
        default=[],
    )
    parser.add_argument(
        "--proxy",
        action="store_true",
        help="Whether the build plan is generated by the GHC proxy",
        default=False,
    )
...
def obtain_target_metadata(args):
    ...
    if args.build_plan != None or args.proxy:
...
def run_ghc_depends(
    ...
    with tempfile.TemporaryDirectory() as dname:
        ...
        args_outer = [str(ghc.absolute()), "@" + os.path.abspath(ghc_args_file_at)] + direct_args
